...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<form action="AddCooks?userPublisher=${sessionScope.user.userName }"  method="post" enctype="multipart/form-data"> 
			<div class="col-md-10">
				<div class="row">	
				...
				<div class="row">	
					<div class="col-md-6 text-center">
						<label for="photo" class="lead">Enter Photo (JPG...)</label> <input type="file" name="photo" id="photo" class="form-control"  required">
					</div>
					<div class="col-md-6 lead">
						<span id="errorTimeC"> <c:out value="${errorPhoto }"></c:out> </span>  
					</div>
				</div>
